                    ...
                    <table class = "table table-striped">
                        ...
                        <tbody ng-init="getAll()">
                            <tr ng-repeat="d in names| filter:search">
                                ...
                                <td>
                                    <a ng-click="deleteEmployee(d.id)" class="waves-effect waves-light btn margin-bottom-1em">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input id="form-name" class="form-control" ng-model="name" type="text" class="form-control" placeholder="Type name here..." aria-describedby="basic-addon1">
                                    </div>
                                    <div class="form-group">
                                        <span class="control-label" id="basic-addon1">Dept (Maneger)</span>
                                        <input id="form-name" class="form-control" ng-model="dept" type="text" class="form-control" placeholder="Type dept here..." aria-describedby="basic-addon1">
                                    </div>
                                    <div class="form-group">
                                        <span class="control-label" id="basic-addon1">Salary (0000.0000)</span>
                                        <input id="form-name" class="form-control" id="form-salary" ng-model="salary" type="text" class="form-control" placeholder="Type salary here..." aria-describedby="basic-addon1">
                                    </div>
                                </div>
